...
public class WordSortTest
{
    public static void main(String[] args)
    {
        ...
        // load words from words into array list; see helper method below
    ...
    // helper method to load words from words
    public static void loadWordsInto(ArrayList<String> wordList)
    {
        try
        {
            Scanner input = new Scanner(new File("C:\\Users\\BT_3W2_01\\IdeaProjects\\FazilovU7T6Lab\\src\\words.txt"));
            while (input.hasNext())
            {
